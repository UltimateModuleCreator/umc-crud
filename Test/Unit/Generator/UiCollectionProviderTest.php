...
use Umc\Crud\Generator\UiCollectionProvider;
use Umc\Crud\Generator\NameMatcher;

class UiCollectionProviderTest extends TestCase
{
    /**
    ...
    private $parameter;
    /**
     * @var UiCollectionProvider
     */
    private $uiCollectionProvider;
    ...
    protected function setUp(): void
    {
        ...
        $this->uiCollectionProvider = new UiCollectionProvider(
            $this->nameMatcher,
            DataObject::class,
            '\Result\Class',
            $this->ioObject,
    ...
    /**
     * @covers \Umc\Crud\Generator\UiCollectionProvider
     */
    public function testGenerate()
    {
        ...
        $this->assertEquals('filename.php', $this->uiCollectionProvider->generate());
    }
}
